...
class bxcg(object):
    ...
    def ab(self):
        ...
        if self.step == 201:
            ...
            self.dp['dns_scaler']= why['dns_scaler']
            self.dp['div_scaler']= why['div_scaler']
...
#    print ("Inside python m =", step )
    ...
    #        'vel': vel}
        ...
        prs_feat['dns']=fdns.astype(np.float32)
    ...
    #print(ipos)
        ...
        #vel = vel / np.sqrt(pre_scaler.var_.item())
        ...
        #pres = pred.cpu().numpy() * np.sqrt(prs_vel_norm_scaler.var_.item())
